...
namespace sample {
    ...
    bool Image::setContentFromBitmap(JNIEnv *env, jobject bitmap) {
        ...
        RET_CHECK(AndroidBitmap_lockPixels(env, bitmap, &bitmapData) ==
        ...
        vkCmdCopyBufferToImage(copyCommand.handle(), stagingBuffer->getBufferHandle(),
                               mImage.handle(),
    ...
    bool Image::createImageFromAHardwareBuffer(AHardwareBuffer *buffer) {
        ...
        CALL_VK(vkGetAndroidHardwareBufferPropertiesANDROID, mContext->device(), mBuffer,
                &properties);
    ...
    bool Image::createSampler() {
        ...
        CALL_VK(vkCreateSampler, mContext->device(), &samplerCreateInfo, nullptr,
                mSampler.pHandle());
        return true;
    }
    ...
    bool Image::createImageView() {
        ...
        CALL_VK(vkCreateImageView, mContext->device(), &viewCreateInfo, nullptr,
                mImageView.pHandle());
        return true;
    }
